          ...
          <div id="baseStatsTable" class="section">
            <table>
              <tr>
                ...
                <td>
                  <progress max="255" value="${pokemon.baseStats.hp
        }"></progress>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <progress max="255" value="${pokemon.baseStats.attack
        }"></progress>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <progress max="255" value="${pokemon.baseStats.defense
        }"></progress>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <progress max="255" value="${pokemon.baseStats.specialAttack
        }"></progress>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <progress max="255" value="${pokemon.baseStats.specialDefense
        }"></progress>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <progress max="255" value="${pokemon.baseStats.speed
        }"></progress>
                </td>
              </tr>
              <tr>
